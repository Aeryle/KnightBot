...
*/
declare namespace Photon.LoadBalancing {
...
*/
declare namespace Photon.Lite.Constants {
    const LiteOpKey: {
        ActorList: number;
        ActorNr: number;
...
declare namespace Photon.LoadBalancing.Constants {
    /**
...
*/
declare namespace Photon.Chat.Constants {
    const ParameterCode: {
        Channels: number;
        Channel: number;
        Messages: number;
