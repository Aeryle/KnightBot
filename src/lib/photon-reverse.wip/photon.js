      ...
      LoadBalancingClient.prototype.joinRoom = function (roomName, options, createOptions) {
        ...
        if (options) {
          if (options.createIfNotExists) {
            op.push(
              LoadBalancing.Constants.ParameterCode.JoinMode,
              Photon.TypeExt.Byte(LoadBalancingClient.JoinMode.CreateIfNotExists)
            )
          ...
          if (options.rejoin) {
            op.push(
              LoadBalancing.Constants.ParameterCode.JoinMode,
              Photon.TypeExt.Byte(LoadBalancingClient.JoinMode.RejoinOnly)
            )
          }
          if (options.expectedUsers) {
            op.push(LoadBalancing.Constants.ParameterCode.Add, Photon.TypeExt.String(options.expectedUsers))
