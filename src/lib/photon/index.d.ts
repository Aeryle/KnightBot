...
export namespace Photon {
  ...
  /**
    ...
    **/
  function setOnLoad(onLoad: () => void): void
  /**
  ...
  class PhotonPeer {
    ...
    private address
    private subprotocol
    static webSocketImpl?: new (url: string, protocols?: string) => WebSocket
    static setWebSocketImpl(impl: new (url: string, protocols?: string) => WebSocket): void
...
*/
export namespace Photon.LoadBalancing {
  ...
  class Actor {
    ...
    private suspended
    _updateFromResponse(vals: { [index: string]: any }): void
    _updateMyActorFromResponse(vals: { [index: string]: any }): void
    private updateIfExists
    _updateFromProps(props: { [index: string]: any }): void
  ...
  class Room extends RoomInfo {
    ...
    /**
        ...
        */
    setEmptyRoomLiveTime(ttl: number): void
    /**
    ...
    /**
        ...
        */
    setSuspendedPlayerLiveTime(ttl: number): void
    /**
  ...
  class LoadBalancingClient {
    ...
    onEventNative: ((code: number, vals: number) => boolean) | null
    /**
    ...
    onRoomListUpdate(
      rooms: RoomInfo[],
      roomsUpdated: RoomInfo[],
      roomsAdded: RoomInfo[],
      roomsRemoved: RoomInfo[]
    ): void
    /**
    ...
    joinRandomOrCreateRoom(
      ...
      createOptions?: CreateIfNotExistsRandomRoomOptions
    ): boolean
    ...
    /**
        ...
        */
    suspendRoom(options?: { sendAuthCookie?: boolean }): void
    /**
            ...
            @property {boolean} [options.sendAuthCookie] Securely transmit the encrypted object AuthCookie to the web service in PathLeave webhook when available
        */
    leaveRoom(options?: { sendAuthCookie?: boolean }): void
    /**
            @summary Raises game custom event
    ...
    /**
        ...
        */
    setLogLevel(level: Photon.LogLevel): void
  ...
  class GamePeer extends LbcPeer {
    ...
    constructor(client: LoadBalancingClient, protocol: Photon.ConnectionProtocol, address: string, subprotocol: string)
    onUnhandledEvent(code: number, args: any): void
    onEventNative: (code: number, vals: number) => boolean
    onUnhandledResponse(code: number, args: any): void
    raiseEvent(
      eventCode: number,
      data?: any,
...
*/
export namespace Photon.Lite.Constants {
  const LiteOpKey: {
    ActorList: number
    ActorNr: number
...
export namespace Photon.LoadBalancing.Constants {
  /**
...
*/
export namespace Photon.Chat.Constants {
  const ParameterCode: {
    Channels: number
    Channel: number
    Messages: number
...
export namespace Photon.Chat {
  ...
  class Channel {
    ...
    readProperties(props: { [index: string]: any }): void
...
//            @borrows Photon.LoadBalancing.LoadBalancingClient#connectToNameServer // overrides with connectToNameServer with different parameters
    ...
    /**
            ...
            @returns {boolean} True if current client state allows connection.
        */
    connectToNameServer(options?: { region?: string }): boolean
    /**
            @summary Connects to a specific region's Master server, using the NameServer to find the IP.
